...
class ReportAPITestCase(APITestCase):
    ...
    def test_report_detail(self):
        ...
        url = reverse('reporting:report-detail', kwargs={'pk': self.report1.id})
        response = self.client.get(url)
    ...
    def test_report_progress(self):
        ...
        url = reverse('reporting:report-progress', kwargs={'pk': self.report2.id})
        response = self.client.get(url)
    ...
    def test_report_regenerate(self):
        ...
        url = reverse('reporting:report-regenerate', kwargs={'pk': self.report1.id})
    ...
    def test_report_download(self, mock_open, mock_exists):
        ...
        url = reverse('reporting:report-download', kwargs={'pk': self.report1.id})
        response = self.client.get(url)
    ...
    def test_report_download_not_ready(self):
        ...
        url = reverse('reporting:report-download', kwargs={'pk': self.report2.id})
        response = self.client.get(url)
    ...
    def test_report_share_creation(self):
        ...
        url = reverse('reporting:report-share', kwargs={'pk': self.report1.id})
        data = {
            'share_type': 'LINK',
            'can_download': True,
    ...
    def test_report_metrics(self):
        ...
        url = reverse('reporting:report-metrics', kwargs={'pk': self.report1.id})
        response = self.client.get(url)
    ...
    def test_bulk_operations_delete(self):
        ...
        url = reverse('reporting:report-bulk-operations')
        data = {
    ...
    def test_report_types(self):
        ...
        url = reverse('reporting:report-types')
        response = self.client.get(url)
...
class ReportTemplateAPITestCase(APITestCase):
    ...
    def test_template_list(self):
        ...
        url = reverse('reporting:reporttemplate-list')
        response = self.client.get(url)
    ...
    def test_template_use(self):
        ...
        url = reverse('reporting:template-use', kwargs={'pk': self.template.id})
        data = {
...
class AnalyticsAPITestCase(APITestCase):
    ...
    def test_dashboard_admin(self):
        ...
        url = reverse('reporting:analytics-dashboard')
        response = self.client.get(url)
    ...
    def test_trends(self):
        ...
        url = reverse('reporting:analytics-trends')
...
class ReportPermissionTestCase(APITestCase):
    ...
    def test_admin_can_access_all_reports(self):
        ...
        url = reverse('reporting:report-detail', kwargs={'pk': self.report.id})
        response = self.client.get(url)
...
class ReportIntegrationTestCase(APITestCase):
    ...
    def test_end_to_end_report_generation(self):
        ...
        # 2. Check progress
        progress_url = reverse('reporting:report-progress', kwargs={'pk': report_id})
        ...
        # 4. Create share
        share_url = reverse('reporting:report-share', kwargs={'pk': report_id})
        share_data = {
            'share_type': 'LINK',
            'can_download': True
        }
        ...
        metrics_url = reverse('reporting:report-metrics', kwargs={'pk': report_id})
    ...
    def test_template_workflow(self):
        ...
        # 1. Create template
        template_url = reverse('reporting:reporttemplate-list')
        template_data = {
        ...
        use_url = reverse('reporting:template-use', kwargs={'pk': template_id})
        use_data = {
